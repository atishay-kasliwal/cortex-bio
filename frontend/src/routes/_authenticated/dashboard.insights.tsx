...
function InsightsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Insights"
        description="Patterns we've detected in your biometric data over the last 14 days."
      />
      <div className="space-y-3">
        {isLoading ? (
          ...
          <p className="text-sm text-muted-foreground">
            No insights yet. More data unlocks pattern detection.
          </p>
        ) : (
          insights.map((i) => {
            ...
            return (
              ...
              >
                <div
                  className={`mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-border bg-muted/40 ${color}`}
                >
