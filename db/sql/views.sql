-- Cortex Bio analytics views
-- Run after init migration: npm run db:views

-- ---------------------------------------------------------------------------
-- v_user_baselines: 30-day rolling baselines per user
-- ---------------------------------------------------------------------------
...
COMMENT ON VIEW v_user_baselines IS '30-day HRV, resting HR, sleep, steps, and readiness baselines per user';

-- ---------------------------------------------------------------------------
-- v_weekly_features: rolling 7-day averages aligned to each feature date
-- ---------------------------------------------------------------------------
...
COMMENT ON VIEW v_weekly_features IS 'Rolling 7-day averages and sleep consistency per user per day';

-- ---------------------------------------------------------------------------
-- v_monthly_features: rolling 30-day averages aligned to each feature date
-- ---------------------------------------------------------------------------
...
COMMENT ON VIEW v_monthly_features IS 'Rolling 30-day lifestyle baselines per user per day';
